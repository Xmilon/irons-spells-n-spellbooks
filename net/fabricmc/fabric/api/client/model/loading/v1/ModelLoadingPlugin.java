...
public interface ModelLoadingPlugin {
	...
	interface Context {
		 ...
		 * {@link FabricBakedModelManager#getModel(class_2960)}.
		 */
		void addModels(class_2960... ids);

		/**
		 * Adds multiple models that will be loaded, baked, and made available through
		 * {@link FabricBakedModelManager#getModel(class_2960)}.
		 */
		void addModels(Collection<? extends class_2960> ids);
		 ...
		 * block.
		 */
		void registerBlockStateResolver(class_2248 block, BlockStateResolver resolver);
		 ...
		 * (e.g. wrap a block's model into a non-{@link class_793} class but still allow the item model to be
