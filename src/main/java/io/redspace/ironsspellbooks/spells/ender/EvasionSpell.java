...
public class EvasionSpell extends AbstractSpell {
    ...
    public void onCast(Level world, int spellLevel, LivingEntity entity, CastSource castSource, MagicData playerMagicData) {
        entity.addEffect(new MobEffectInstance(net.minecraft.core.registries.BuiltInRegistries.MOB_EFFECT.wrapAsHolder(MobEffectRegistry.EVASION.get()), 60 * 20, (int) getSpellPower(spellLevel, entity), false, false, true));
